...
import { BookOpen, Calendar, Folder, LayoutGrid, Menu, Search, Shield, User, Wrench } from 'lucide-react';
...
export function AppHeader({ breadcrumbs = [] }: Props) {
    ...
    const datesUrl = currentTeam ? dates(currentTeam.slug) : '/';
    const rolesUrl = currentTeam ? roles(currentTeam.slug) : '/';
    const statusesUrl = currentTeam ? statuses(currentTeam.slug) : '/';
